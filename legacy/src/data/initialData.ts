...
export const INITIAL_CAPTURES: CaptureItem[] = [
  ...
  {
    id: 'cap-3',
    title: 'Whiteboard sketch of habit architecture',
    type: 'photo',
    noteText: 'Drafted 3-part loop: trigger (morning alarm), 30-second micro-action (fill water bottle), dopamine reward (check off item).',
    imageUrl: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="600" height="340" viewBox="0 0 600 340"><rect width="600" height="340" fill="%231E1E24"/><rect x="20" y="20" width="560" height="300" rx="16" fill="%232A2B36" stroke="%23FF5B5B" stroke-width="2" stroke-dasharray="6,6"/><text x="300" y="110" fill="%23FFFFFF" font-family="sans-serif" font-size="20" font-weight="bold" text-anchor="middle">Whiteboard Habit Loop Diagram</text><text x="300" y="155" fill="%23FF5B5B" font-family="monospace" font-size="14" text-anchor="middle">Trigger ➔ 30s Micro-Action ➔ Dopamine Check</text><rect x="60" y="195" width="140" height="70" rx="10" fill="%23FF5B5B" fill-opacity="0.2" stroke="%23FF5B5B"/><text x="130" y="235" fill="%23FFFFFF" font-family="monospace" font-size="12" text-anchor="middle">1. Alarm Ring</text><rect x="230" y="195" width="140" height="70" rx="10" fill="%236366F1" fill-opacity="0.2" stroke="%236366F1"/><text x="300" y="235" fill="%23FFFFFF" font-family="monospace" font-size="12" text-anchor="middle">2. Water Bottle</text><rect x="400" y="195" width="140" height="70" rx="10" fill="%2310B981" fill-opacity="0.2" stroke="%2310B981"/><text x="470" y="235" fill="%23FFFFFF" font-family="monospace" font-size="12" text-anchor="middle">3. Checkmark</text></svg>',
    createdAt: new Date(Date.now() - 3600000 * 12).toISOString(),
    status: 'unprocessed',
    suggestedLifeAreaId: 'area-4',
  },
  {
    id: 'cap-4',
...
export const INITIAL_TASKS: TaskItem[] = [
  ...
  },
  {
    ...
    description: 'Categorize receipts and reconcile bank accounts.',
    lifeAreaId: 'area-3',
    status: 'completed',
    priority: 'medium',
    ...
    focusMinutesTarget: 20,
    focusMinutesLogged: 20,
  },
  {
    id: 'task-hist-2',
    title: 'Draft architecture roadmap for API',
    description: 'Map out endpoints and payload contracts.',
    lifeAreaId: 'area-1',
    status: 'completed',
    priority: 'high',
  ...
  {
    id: 'task-hist-3',
    title: 'Take 20-min brisk walk in nature',
    description: 'Clear mind and boost dopamine without phone.',
    lifeAreaId: 'area-2',
    status: 'completed',
    priority: 'low',
    dueDate: new Date(Date.now() - 86400000 * 2).toISOString().split('T')[0],
  ...
  {
    id: 'task-hist-4',
    title: 'Clear desk workspace of clutter',
    description: 'Clean visual field to minimize task switching distractions.',
    lifeAreaId: 'area-3',
    status: 'completed',
    priority: 'low',
  ...
  {
    id: 'task-hist-5',
    title: 'Synthesize user research interviews',
    description: 'Tag recurring feedback themes into 3 key categories.',
    lifeAreaId: 'area-1',
    status: 'completed',
    priority: 'high',
  ...
  {
    id: 'task-hist-6',
    title: 'Hydration goal: 2.5 Liters reached',
    description: 'Track water bottle refills throughout workday.',
    lifeAreaId: 'area-2',
    status: 'completed',
    priority: 'low',
    dueDate: new Date(Date.now() - 86400000 * 4).toISOString().split('T')[0],
  ...
  {
    id: 'task-hist-7',
    title: 'Organize painting supplies and canvas easel',
    description: 'Set up art corner for evening relaxation.',
    lifeAreaId: 'area-5',
    status: 'completed',
    priority: 'low',
  ...
  {
    id: 'task-hist-8',
    title: 'Finish module 3 of executive function masterclass',
    description: 'Take notes on timeboxing and reward pacing.',
    lifeAreaId: 'area-4',
    status: 'completed',
    priority: 'medium',
