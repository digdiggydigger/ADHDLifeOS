        ...
        Section {
            ...
            Text(
                "Haptics are the app's tactile confirmations — saving, promoting, starting a "
                    ...
                    + "confirm a finished sprint, and the milestones for clearing your inbox, "
                    + "finishing a routine, a seven-day streak and hitting your daily goal; "
                    + "haptics and the small in-place flourishes are left alone either way. "
                    + "Celebration sounds adds one soft chime to those moments; it mixes under "
                    + "whatever you are listening to and stays quiet when your phone is on "
                    + "silent. Notification sounds only covers "
